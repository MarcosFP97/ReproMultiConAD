#!/bin/bash
#SBATCH --job-name=E5_en_binary      # Job name
...
export LANG=C.UTF-8
python /mnt/beegfs/groups/irgroup/sara_tfg/MultiConAD/Experiments/e5_larg_classifier.py --test_language en --task binary --translated no
