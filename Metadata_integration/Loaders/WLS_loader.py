...
class WLSLoader(BaseMetadataLoader):
    ...
    def __init__(self, excel_path="./WLS/WLS-data.xlsx"):
    ...
    def load_metadata(self):
        ...
        # Map numeric sex codes to strings
        ...
        # Expected columns: education and screeningresult with values N/Y
        ...
        for _, row in df.iterrows():
            file_id = str(row['idtlkbnk'])[-5:] # Keep only the last 5 digits, as appears in File_ID
