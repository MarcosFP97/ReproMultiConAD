...
class VASLoader(BaseMetadataLoader):
    ...
    def __init__(self, excel_path="/mnt/beegfs/groups/irgroup/datasets/sara_tfg_multiconad/VAS/VAS-data.xlsx"):
    ...
    def load_metadata(self):
        ...
        for _, row in df.iterrows():
            file_id = str(row["vas id"]).strip().zfill(3) # Para ponerlo en dígitos, como en File_ID : 001, 052, 100...
